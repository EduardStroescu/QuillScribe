...
export const USERS = [
  ...
  },
  {
    name: "David",
    message:
      "I was skeptical at first, but QuillScribe exceeded my expectations. Our project timelines have improved, and collaboration between teams is seamless.",
  },
  {
    name: "Ella",
    message:
  ...
  },
  {
    name: "Sam",
    message:
      "QuillScribe is a fantastic tool that has revolutionized our workflow. Our productivity and collaboration have reached new heights.",
  },
];
...
export const PRICING_CARDS = [
  ...
  },
  {
    ...
    highlightFeature: "Everything included in the free plan +",
    freatures: [
      "Unlimited blocks for teams",
      "Unlimited file uploads",
