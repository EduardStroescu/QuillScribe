...
import { findFileById, findFolderById } from "@/lib/utils";
...
const Dropdown: React.FC<DropdownProps> = ({
  ...
  const folderTitle: string | undefined = useMemo(() => {
    if (listType === "folder") {
      const stateTitle = findFolderById(state, workspaceId, id)?.title;
  ...
  //File/Folder title edit listener
  ...
  // File/Folder emoji change and notification
  ...
  return (
    ...
    >
      ...
      <AccordionContent>
        {findFolderById(state, workspaceId, id)
